...
def get_algs():
    ...
    algs = {
        ...
        "Permutations": {"enc": Permutations.enc, "dec": Permutations.dec},
        "Kardano": {"enc": Kardano.enc, "dec": Kardano.dec},
    }
...
def key_required(alg):
    return alg in ["Cesar", "Belazo", "Vizhiner", "Matrix", "Playfair", "Permutations"]
